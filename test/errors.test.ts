...
test('toEqualTypeOf error message', async () => {
  expect(tsErrors(`expectTypeOf({a: 1}).toEqualTypeOf<{a: string}>()`)).toMatchInlineSnapshot(`
    "test/test.ts:99:99 - error TS2344: Type '{ a: string; }' does not satisfy the constraint '{ a: \\"Expected: string, Actual: number\\"; }'.
      Types of property 'a' are incompatible.
        Type 'string' is not assignable to type '\\"Expected: string, Actual: number\\"'.

    99 expectTypeOf({a: 1}).toEqualTypeOf<{a: string}>()
                                         ~~~~~~~~~~~
    "
  `)
})
...
test('toEqualTypeOf special types', async () => {
  expect(
    ...
    "test/test.ts:99:99 - error TS2344: Type '{ a: 1; }' does not satisfy the constraint '{ a: never; }'.
      Types of property 'a' are incompatible.
        Type 'number' is not assignable to type 'never'.

    99 expectTypeOf<{a: any}>().toEqualTypeOf<{a: 1}>()
                                             ~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: 1; }' does not satisfy the constraint '{ a: \\"Expected: literal number: 1, Actual: never\\"; }'.
      Types of property 'a' are incompatible.
        Type '1' is not assignable to type '\\"Expected: literal number: 1, Actual: never\\"'.

    99 expectTypeOf<{a: never}>().toEqualTypeOf<{a: 1}>()
                                               ~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: 1; }' does not satisfy the constraint '{ a: \\"Expected: literal number: 1, Actual: unknown\\"; }'.
      Types of property 'a' are incompatible.
        Type '1' is not assignable to type '\\"Expected: literal number: 1, Actual: unknown\\"'.

    99 expectTypeOf<{a: unknown}>().toEqualTypeOf<{a: 1}>()
                                                 ~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: any; }' does not satisfy the constraint '{ a: never; }'.
      Types of property 'a' are incompatible.
        Type 'any' is not assignable to type 'never'.

    99 expectTypeOf<{a: 1}>().toEqualTypeOf<{a: any}>()
                                           ~~~~~~~~
    test/test.ts:99:99 - error TS2554: Expected 1 arguments, but got 0.

    99 expectTypeOf<{a: 1}>().toEqualTypeOf<{a: never}>()
                             ~~~~~~~~~~~~~~~~~~~~~~~~~~~

      src/index.ts:99:99
        99       ...MISMATCH: MismatchArgs<StrictEqualUsingTSInternalIdenticalToOperator<Actual, Expected>, true>
                  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Arguments for the rest parameter 'MISMATCH' were not provided.
    test/test.ts:99:99 - error TS2344: Type '{ a: unknown; }' does not satisfy the constraint '{ a: \\"Expected: unknown, Actual: never\\"; }'.
      Types of property 'a' are incompatible.
        Type 'unknown' is not assignable to type '\\"Expected: unknown, Actual: never\\"'.

    99 expectTypeOf<{a: 1}>().toEqualTypeOf<{a: unknown}>()
                                           ~~~~~~~~~~~~
    "
  `)
})
...
test('toEqualTypeOf with literals', async () => {
  expect(
    ...
    "test/test.ts:99:99 - error TS2344: Type '{ a: \\"abc\\"; }' does not satisfy the constraint '{ a: \\"Expected: literal string: abc, Actual: string\\"; }'.
      Types of property 'a' are incompatible.
        Type '\\"abc\\"' is not assignable to type '\\"Expected: literal string: abc, Actual: string\\"'.

    99 expectTypeOf<{a: string}>().toEqualTypeOf<{a: 'abc'}>()
                                                ~~~~~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: string; }' does not satisfy the constraint '{ a: \\"Expected: string, Actual: never\\"; }'.
      Types of property 'a' are incompatible.
        Type 'string' is not assignable to type '\\"Expected: string, Actual: never\\"'.

    99 expectTypeOf<{a: 'abc'}>().toEqualTypeOf<{a: string}>()
                                               ~~~~~~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: \\"xyz\\"; }' does not satisfy the constraint '{ a: \\"Expected: literal string: xyz, Actual: literal string: abc\\"; }'.
      Types of property 'a' are incompatible.
        Type '\\"xyz\\"' is not assignable to type '\\"Expected: literal string: xyz, Actual: literal string: abc\\"'.

    99 expectTypeOf<{a: 'abc'}>().toEqualTypeOf<{a: 'xyz'}>()
                                               ~~~~~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: 1; }' does not satisfy the constraint '{ a: \\"Expected: literal number: 1, Actual: number\\"; }'.
      Types of property 'a' are incompatible.
        Type '1' is not assignable to type '\\"Expected: literal number: 1, Actual: number\\"'.

    99 expectTypeOf<{a: number}>().toEqualTypeOf<{a: 1}>()
                                                ~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: number; }' does not satisfy the constraint '{ a: \\"Expected: number, Actual: never\\"; }'.
      Types of property 'a' are incompatible.
        Type 'number' is not assignable to type '\\"Expected: number, Actual: never\\"'.

    99 expectTypeOf<{a: 1}>().toEqualTypeOf<{a: number}>()
                                           ~~~~~~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: 2; }' does not satisfy the constraint '{ a: \\"Expected: literal number: 2, Actual: literal number: 1\\"; }'.
      Types of property 'a' are incompatible.
        Type '2' is not assignable to type '\\"Expected: literal number: 2, Actual: literal number: 1\\"'.

    99 expectTypeOf<{a: 1}>().toEqualTypeOf<{a: 2}>()
                                           ~~~~~~
    test/test.ts:99:99 - error TS2344: Type '{ a: true; }' does not satisfy the constraint '{ a: \\"Expected: literal boolean: true, Actual: literal boolean: false\\"; }'.
      Types of property 'a' are incompatible.
        Type 'true' is not assignable to type '\\"Expected: literal boolean: true, Actual: literal boolean: false\\"'.

    99 expectTypeOf<{a: boolean}>().toEqualTypeOf<{a: true}>()
                                                 ~~~~~~~~~
...
test('.toMatchTypeOf error message', async () => {
  expect(tsErrors(`expectTypeOf({a: 1}).toMatchTypeOf<{a: string}>()`)).toMatchInlineSnapshot(`
    ...
    99 expectTypeOf({a: 1}).toMatchTypeOf<{a: string}>()
                                         ~~~~~~~~~~~
    "
  `)
})
...
test('toBeNullable', async () => {
  ...
  expect(tsErrors(okAssertion + '\n' + okAssertion.replace('.toBe', '.not.toBe'))).toMatchInlineSnapshot(`
    "test/test.ts:99:99 - error TS2349: This expression is not callable.
      Type 'Inverted<ExpectNullable<1 | undefined>>' has no call signatures.

    99 expectTypeOf<1 | undefined>().not.toBeNullable()
                                        ~~~~~~~~~~~~
    "
  `)
})
...
test('usage.test.ts', () => {
  ...
  expect(tsFileErrors({filepath: 'test/usage.test.ts', content: usageTestFile})).toMatchInlineSnapshot(`
    ...
    99   expectTypeOf<Apple>().toEqualTypeOf<Fruit>()
                                             ~~~~~
    test/usage.test.ts:99:99 - error TS2554: Expected 0 arguments, but got 1.
    ...
    99   expectTypeOf(1).toBeNullable()
                          ~~~~~~~~~~~~
    test/usage.test.ts:99:99 - error TS2344: Type 'number' does not satisfy the constraint '\\"Expected: number, Actual: string\\"'.

    99   expectTypeOf<string | number>().toMatchTypeOf<number>()
                                                        ~~~~~~
    test/usage.test.ts:99:99 - error TS2554: Expected 2 arguments, but got 1.

    99   expectTypeOf<ResponsiveProp<number>>().exclude<number | number[]>().toHaveProperty('xxl')
                                                                              ~~~~~~~~~~~~~~~~~~~~~

      src/index.ts:99:99
        99     ...MISMATCH: MismatchArgs<Extends<K, keyof Actual>, Options['positive']>
                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Arguments for the rest parameter 'MISMATCH' were not provided.
    test/usage.test.ts:99:99 - error TS2554: Expected 2 arguments, but got 1.

    99   expectTypeOf(obj).toHaveProperty('c')
                            ~~~~~~~~~~~~~~~~~~~
    ...
    99   expectTypeOf<any[]>().toEqualTypeOf<number[]>()
                                              ~~~~~~~~
    test/usage.test.ts:99:99 - error TS2344: Type '{ a: number; }' does not satisfy the constraint '{ a: \\"Expected: number, Actual: string\\"; }'.
      Types of property 'a' are incompatible.
        Type 'number' is not assignable to type '\\"Expected: number, Actual: string\\"'.

    99   expectTypeOf<{a: string}>().toEqualTypeOf<{a: number}>()
                                                    ~~~~~~~~~~~
    test/usage.test.ts:99:99 - error TS2344: Type '{}' does not satisfy the constraint '{ a: \\"Expected: never, Actual: number\\" | \\"Expected: never, Actual: undefined\\"; }'.
      Property 'a' is missing in type '{}' but required in type '{ a: \\"Expected: never, Actual: number\\" | \\"Expected: never, Actual: undefined\\"; }'.

    99   expectTypeOf<{a?: number}>().toEqualTypeOf<{}>()
                                                     ~~
    test/usage.test.ts:99:99 - error TS2344: Type '{ a: number; }' does not satisfy the constraint '{ a: \\"Expected: number, Actual: undefined\\"; }'.
      Types of property 'a' are incompatible.
        Type 'number' is not assignable to type '\\"Expected: number, Actual: undefined\\"'.

    99   expectTypeOf<{a?: number}>().toEqualTypeOf<{a: number}>()
                                                     ~~~~~~~~~~~
    test/usage.test.ts:99:99 - error TS2554: Expected 1 arguments, but got 0.

    99   expectTypeOf<{a?: number}>().toEqualTypeOf<{a: number | undefined}>()
                                       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      src/index.ts:99:99
        99       ...MISMATCH: MismatchArgs<StrictEqualUsingTSInternalIdenticalToOperator<Actual, Expected>, true>
                  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Arguments for the rest parameter 'MISMATCH' were not provided.
    test/usage.test.ts:99:99 - error TS2344: Type '{ a: number | null; }' does not satisfy the constraint '{ a: \\"Expected: number, Actual: undefined\\" | \\"Expected: null, Actual: undefined\\"; }'.
      Types of property 'a' are incompatible.
    ...
    99   expectTypeOf<{a?: number | null}>().toEqualTypeOf<{a: number | null}>()
                                                            ~~~~~~~~~~~~~~~~~~
    test/usage.test.ts:99:99 - error TS2344: Type '{ a: {}; }' does not satisfy the constraint '{ a: { b: \\"Expected: never, Actual: number\\" | \\"Expected: never, Actual: undefined\\"; }; }'.
      Types of property 'a' are incompatible.
        Property 'b' is missing in type '{}' but required in type '{ b: \\"Expected: never, Actual: number\\" | \\"Expected: never, Actual: undefined\\"; }'.

    99   expectTypeOf<{a: {b?: number}}>().toEqualTypeOf<{a: {}}>()
                                                          ~~~~~~~
    test/usage.test.ts:99:99 - error TS2554: Expected 1 arguments, but got 0.

    99   expectTypeOf<A1>().toEqualTypeOf<E1>()
                             ~~~~~~~~~~~~~~~~~~~
    ...
    99   expectTypeOf<A2>().toEqualTypeOf<E2>()
                             ~~~~~~~~~~~~~~~~~~~
    ...
    99   expectTypeOf<typeof A>().toEqualTypeOf<typeof B>()
                                   ~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    99   expectTypeOf<{a: 1} & {b: 2}>().toEqualTypeOf<{a: 1; b: 2}>()
                                          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    99   expectTypeOf<{a: {b: 1} & {c: 1}}>().toEqualTypeOf<{a: {b: 1; c: 1}}>()
                                               ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      src/index.ts:99:99
        99       ...MISMATCH: MismatchArgs<StrictEqualUsingTSInternalIdenticalToOperator<Actual, Expected>, true>
                  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Arguments for the rest parameter 'MISMATCH' were not provided.
    test/usage.test.ts:99:99 - error TS2344: Type '() => () => () => () => 2' does not satisfy the constraint '() => () => () => () => 1'.
      Call signature return types '() => () => () => 2' and '() => () => () => 1' are incompatible.
        Call signature return types '() => () => 2' and '() => () => 1' are incompatible.
          Call signature return types '() => 2' and '() => 1' are incompatible.
            Type '2' is not assignable to type '1'.

    99   expectTypeOf<() => () => () => () => 1>().toEqualTypeOf<() => () => () => () => 2>()
                                                                  ~~~~~~~~~~~~~~~~~~~~~~~~~
    test/usage.test.ts:99:99 - error TS2554: Expected 1 arguments, but got 0.

    99   expectTypeOf<() => () => () => () => {a: 1} & {b: 2}>().toEqualTypeOf<
                                                                  ~~~~~~~~~~~~~~
    350     () => () => () => () => {a: 1; b: 2}
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    351   >()
