...
export type TSPost53OverloadsInfoTuple<F> = F extends {
...
export type TSPre53OverloadsInfoTuple<F> = F extends () => infer R
  ? DecreasingOverloadsInfoTuple<F> extends infer T
    ? Extract<
        {
          [K in keyof T]: StrictEqualUsingTSInternalIdenticalToOperator<
            T[K],
...
export type DecreasingOverloadsInfoTuple<F> = F extends {
  (...args: infer A1): infer R1
  (...args: infer A2): infer R2
  (...args: infer A3): infer R3
  (...args: infer A4): infer R4
